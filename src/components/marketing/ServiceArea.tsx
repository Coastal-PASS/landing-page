    ...
    <div className="mx-auto max-w-6xl px-4">
      <header className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-brand-body">
          Every engagement pairs hands-on field expertise with the digital infrastructure your crew needs to stay connected and productive.
        </p>
      </header>
      <div className="mt-12 grid gap-6 md:grid-cols-2">
        {services.map(({ title, description, Icon }) => (
          <Card key={title} className="relative overflow-hidden border border-white/60 shadow-card">
      ...
      <div className="mt-12 flex flex-wrap items-center justify-center gap-6">
        {partnerLogos.map((logo) => (
          <div key={logo.alt} className="rounded-2xl border border-white/70 bg-white px-6 py-3 shadow-sm">

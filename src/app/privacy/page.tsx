...
export const metadata: Metadata = {
  ...
  description: 'Learn how Coastal PASS collects, uses, and protects information within our applications.',
};
  ...
  <>
    ...
    <main className="mx-auto max-w-4xl px-4 py-20">
      <article className="space-y-6 text-brand-body">
        <h1 className="text-3xl font-semibold text-brand-heading">Privacy Policy</h1>
        <p>
          This privacy policy applies to the Coastal PASS app (hereby referred to as &quot;Application&quot;) for mobile devices that was created by Coastal Tractor (hereby referred to as &quot;Service Provider&quot;) as a Free service. This service is intended for use &quot;AS IS&quot;.
        </p>
        <Section title="Information Collection and Use">
          ...
          <Section title="Third Party Access">
            ...
            <ul className="ml-6 list-disc space-y-2">
              <li>
                <a href="https://www.google.com/policies/privacy/" className="text-brand-primary underline" target="_blank" rel="noreferrer">
                  Google Play Services
                </a>
              </li>
              <li>
                <a href="https://firebase.google.com/support/privacy" className="text-brand-primary underline" target="_blank" rel="noreferrer">
          ...
          <Section title="Data Retention Policy">
            <p>
              ...
              <a href="mailto:appdev@coastalpass.services" className="text-brand-primary underline">
          ...
          <Section title="Security">
            <p>The Service Provider is concerned about safeguarding the confidentiality of your information. Physical, electronic, and procedural safeguards protect information the Service Provider processes and maintains.</p>
          </Section>
          <Section title="Changes">
            <p>This Privacy Policy may be updated from time to time for any reason. The Service Provider will notify you of any changes by posting the new Privacy Policy at</p>
            <a href="https://www.coastalpass.services/privacy" className="text-brand-primary underline" target="_blank" rel="noreferrer">
          ...
          <Section title="Contact Us">
            <p>If you have any questions regarding privacy while using the Application, or have questions about our practices, please contact the Service Provider at</p>
            <a href="mailto:appdev@coastalpass.services" className="text-brand-primary underline">
              appdev@coastalpass.services
            </a>
          </Section>
